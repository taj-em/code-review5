...
describe('getCurrentAge', () => {
  ...
  test('should throw an error if age2 is less than age1', () => {
    let currentAgeTest = new UserInput(40, 20, 30);
    let plantAges = (currentAgeTest.getCurrentAge());
    expect(plantAges).toEqual("Error");
  });
...
describe('getYearsUntil', () => {
  ...
  test('should throw an error if ag2 is less than age1', () => {
    let yearsUntilTest = new UserInput(40, 20, 30);
    let yearsUntil = (yearsUntilTest.getYearsUntil());
    expect(yearsUntil).toEqual("Error");
  });
...
describe('getYearSince', () => {
  ...
  test('should throw an error if age1 is less than 0.1', () => {
    let yearSinceTest = new UserInput(0, 50, 30);
  ...
  test('should throw an error if age3 is larger than age1', () => {
    let yearSinceTest = new UserInput(40, 50, 60);
    let yearSince = (yearSinceTest.getYearSince());
    expect(yearSince).toEqual("Error");
  });
